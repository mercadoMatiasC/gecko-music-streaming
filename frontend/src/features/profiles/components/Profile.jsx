export function Profile(){
    ...
    return (
        <section id="user-profile" className="w-full flex flex-col h-screen xl:w-1/4">
            <span className="flex justify-end px-6 py-3">
                <img src="svgs/three-dots.svg" width={24} alt="Options" onClick={() => (1+1)} />
            </span>

            <main className="h-full flex flex-col justify-between p-8">
                <span className="flex flex-col gap-3">
                    <div className="flex items-center justify-between">
                        <img src="#" alt="x" className="bg-neutral-700 w-24 h-24 rounded-full drop-shadow-md drop-shadow-black"/>
